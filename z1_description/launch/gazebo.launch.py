...
def generate_launch_description():
    ...
    # Bridge
    camera_id = ['left', 'right', 'base']
    camera_link = ['left_link06', 'right_link06', 'base']
    arg_bridge = []
    remap_bridge = []
    model_name = 'z1_dual'
    for id in range(len(camera_id)):
        ...
        remap_bridge.append((f'/world/empty/model/{model_name}/link/{camera_link[id]}/sensor/oak_d_lite/camera_info', f'/{camera_id[id]}_camera/camera_info')) 
        remap_bridge.append((f'/world/empty/model/{model_name}/link/{camera_link[id]}/sensor/oak_d_lite/image', f'/{camera_id[id]}_camera/image')) 
        remap_bridge.append((f'/world/empty/model/{model_name}/link/{camera_link[id]}/sensor/oak_d_lite/depth_image', f'/{camera_id[id]}_camera/depth_image')) 
        remap_bridge.append((f'/world/empty/model/{model_name}/link/{camera_link[id]}/sensor/oak_d_lite/points', f'/{camera_id[id]}_camera/points')) 
    ...
    for id in ft_id:
        arg_bridge.append(f'/world/empty/model/{model_name}/joint/{id}_ft_joint/sensor/ft_sensor/forcetorque@geometry_msgs/msg/WrenchStamped@ignition.msgs.Wrench') 
        remap_bridge.append((f'/world/empty/model/{model_name}/joint/{id}_ft_joint/sensor/ft_sensor/forcetorque', f'/{id}_ft_sensor/forcetorque')) 
        
        # for iy in range(tac_ny):
        #     for ix in range(tac_nx):
        #         arg_bridge.append(f'/world/empty/model/{model_name}/joint/{id}_matrix0_{iy}_{ix}_tactile_joint/sensor/ft_sensor/forcetorque@geometry_msgs/msg/Wrench@ignition.msgs.Wrench') 
        #         remap_bridge.append((f'/world/empty/model/{model_name}/joint/{id}_matrix0_{iy}_{ix}_tactile_joint/sensor/ft_sensor/forcetorque', f'/{id}_tactile0_{iy}_{ix}/forcetorque')) 
